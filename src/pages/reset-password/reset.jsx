        ...
        <div className="flex flex-col gap-16 items-right gap-60">
            <div className='flex flex-col gap-60'>
                <div className='flex flex-col gap-16'>
                    <div className="mr-415 font-montserrat text-24">Reset Password</div>
                    <div className='items-left font-400 font-montserrat text-16 text-gray'>Please enter your email address</div>
                </div>

                <div className="w-100">
                <TextField fullWidth id="outlined-basic" label="Email" variant="outlined" size='small' color="green"/>
