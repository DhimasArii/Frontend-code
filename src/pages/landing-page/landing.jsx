      ...
      <ThemeProvider theme={theme}>
        ...
        <div className="flex flex-col items-center w-100">
          ...
          <div id="rectangle" className="flex justify-center bg-box mt-124">
            <div
              id="frame1536"
              className="flex flex-col items-center px-102 pt-65 h-1045 gap-180"
            >
              <div id="1535" className="flex flex-row gap-24">
                <div id="1547" className="flex flex-col gap-24 h-280 w-711">
              ...
              <div id="1534" className="flex flex-col items-center gap-60">
                <div className="text-green font-600 font-montserrat text-24">
                ...
                <div
                  id="frame1533"
                  className="flex flex-basis items-center"
                  style={{ marginRight: 0 }}
                >
                  <div>
                    <Grid container columnSpacing={2} rowSpacing={5}>
                      {data.slice(0, 8).map((item, index) => {
                        console.log(index);
                        return (
                          <Grid key={index} xs={4} maxWidth={232}>
                            <Item>
